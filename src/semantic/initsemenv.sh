...
cp rclsem_common.py  rclsem_embed.py  rclsem_query.py  rclsem_segment.py  rclsem_talk.py  \
   ...
   rclsem_sync.py rclsem_recoll.py rclsem_recoll_bridge.py rclsem_retrieve.py \
   rclsem_answer.py \
   recoll_ai.py recoll_ai_gui.py slicelist.py cmdtalkplugin.py "$venvdir"
(cd "$venvdir";chmod a+x rclsem_embed.py rclsem_query.py rclsem_talk.py \
    recoll_ai.py recoll_ai_gui.py)
